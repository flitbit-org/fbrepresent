...
namespace FlitBit.Represent
{
		...
		where TConcrete : class, T
	{
		...
		public TRepresentation TransformItem(T item) { return _transform.TransformItem(item as TConcrete); }
		...
		public T RestoreItem(TRepresentation representation) { return _transform.RestoreItem(representation); }
